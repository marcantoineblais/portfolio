...
export default function Technologies() {
    return (
        <div className="w-full h-full flex flex-col justify-around gap-3">
            <AboutSection title="Catcam" images={[nodeJs, typescript, nextjs, html, css, javascript, tailwind]} wait={1000} />
            <AboutSection title="Scrabble Cheetah" images={[spring, springboot, nodeJs, typescript, nextjs, html, css, javascript, tailwind, plsql]} wait={2900} />
            <AboutSection title="Portfolio" images={[nodeJs, typescript, nextjs, html, css, javascript, tailwind]} wait={5400} />
        </div>
    )
}