...
export default function AboutSection({
    ...
    return images.map((image, i) => {
      return (
        <Image
          ...
          src={image}
          alt="logo"
          className="w-fit h-16 lg:h-24 px-1.5 lg:px-5 object-contain opacity-0 duration-500"
        />
      );
    });
  }
  ...
  return (
    <div
      ref={containerRef}
      className="py-1 w-full flex flex-col justify-center items-center gap-3 opacity-0 duration-500"
    >
      ...
      <div
        ref={imagesRef}
        className="py-1 flex justify-center items-center flex-wrap gap-3"
      >
        {renderImages()}
      </div>
    </div>
