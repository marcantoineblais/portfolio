            ...
            <div className="w-full h-full flex flex-col justify-center items-center gap-7">
                <Carousel disabledArrows={disabledCarousel} accentColor="bg-emerald-900">
                    ...
                    <ProjectDescription>
                        ...
                        <TextBubble className="bg-orange-100">Il est présentement possible de trouver des solutions en français et en anglais avec plusieurs types de grilles de jeu.</TextBubble>
                        <TextBubble className="bg-orange-100">
                            Vous pouvez sauvegarder jusqu&apos;à 8 parties différentes sur votre compte.
                    ...
                    <Image src={scrabble2Image} alt="Application scrabble cheetah" className="h-full w-full object-contain border border-neutral-300 rounded-lg" />
                    <Image src={scrabble3Image} alt="Application scrabble cheetah" className="h-full w-full object-contain border border-neutral-300 rounded-lg" />
                    <Image src={scrabble4Image} alt="Application scrabble cheetah" className="h-full w-full object-contain border border-neutral-300 rounded-lg" />
                    <Image src={scrabble5Image} alt="Application scrabble cheetah" className="h-full w-full object-contain border border-neutral-300 rounded-lg" />
                </Carousel>
            </div>
        </>
    )
