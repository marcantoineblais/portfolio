...
export default function Hero(
    { opacity, scrollToProjects, scrollToAbout, scrollToContact }:
    { opacity: number, scrollToProjects: Function, scrollToAbout: Function, scrollToContact: Function }
) {
    ...
    return (
        <div className="fixed w-full inset-0 text-gray-300 overflow-y-auto">
            <div ref={containerRef} className="container px-1 w-full h-full mx-auto flex flex-col justify-between items-center gap-12 min-h-[720px] opacity-0">
                <div className="w-full flex flex-col gap-10">
                    ...
                    <div className="w-full px-3 flex flex-col gap-3">
                        <h2 className={`text-lg sm:text-3xl ${kode_mono.className}`}>Pour en savoir plus</h2>
                ...
                <DownArrow text="Voir les réalisations" action={() => scrollToProjects()} disabled={opacity < 1} />
            </div>
        </div>
    )
}