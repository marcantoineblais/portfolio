...
export default function Navbar({ visible, scrollToProject, scrollToAbout }: { visible: boolean, scrollToProject: Function, scrollToAbout: Function }) {
    ...
    return (
        <div ref={navbarRef} className="z-50 fixed top-0 left-0 right-0 text-gray-300 border-b border-b-gray-950 bg-stone-900 -translate-y-full duration-1000">
            <div className="container mx-auto px-3 py-1 flex justify-between gap-3 items-center bg-inherit">
                <div onClick={() => scrollTo({ top: 0, behavior: "smooth" })} className="w-20 flex justify-center items-center cursor-pointer">
